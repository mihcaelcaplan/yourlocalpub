...
import IntlTelInput from 'intl-tel-input/react/src/IntlTelInput';
...
export default function DetailsForm({form, handleCountryChange, preferredShipping}) {
    ...
    return(
        ...
        <form>
            ...
            >
                ...
                preferredDestination={preferredShipping.destination}
                 />
            ...
            > 
                ...
                <Controller 
                    ...
                    render={({ field: {onChange, onBlur, value, ref } }) => (
                        <PhoneInput
                        id="phoneNum"
                        country={preferredShipping.destination.toLowerCase()}
                        onChange={onChange}
                        enableSearch={true}
                        inputStyle={{
...
const CountrySelect = ({form, handleCountryChange, preferredDestination})=>{
    const [register, errors] = form;
    return(        
        <select id="country" defaultValue={"GB"} value={preferredDestination}
        {...register("country", {
            required:true,
        })}
        onChange={(e)=>{
